      ...
      <section id="features" className="py-20 lg:py-32 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 lg:mb-24">
            ...
            <p className="text-lg sm:text-xl text-neutral-300 max-w-2xl mx-auto">En el mercado actual, 10 minutos marcan la diferencia entre conseguir el piso o quedarte fuera.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-xl mx-auto p-12 rounded-[2.5rem] bg-white dark:bg-neutral-800 border-2 border-primary shadow-[0_20px_50px_rgba(34,197,94,0.15)] relative overflow-hidden text-center">
            ...
            <div className="flex items-baseline justify-center mb-8">
              <span className="text-6xl font-black tracking-tighter text-white">19€</span>
              <span className="ml-2 text-neutral-300 font-bold">/mes</span>
            </div>

            <ul className="space-y-5 mb-10 text-left max-w-sm mx-auto">
              <li className="flex items-center font-bold text-neutral-200"><Check className="text-primary mr-3 w-5 h-5" /> Alertas ilimitadas en tiempo real</li>
              <li className="flex items-center font-bold text-neutral-200"><Check className="text-primary mr-3 w-5 h-5" /> Monitorización cada 2 minutos</li>
              <li className="flex items-center font-bold text-neutral-200"><Check className="text-primary mr-3 w-5 h-5" /> Todos los portales (Idealista, Fotocasa...)</li>
              <li className="flex items-center font-bold text-neutral-200"><Check className="text-primary mr-3 w-5 h-5" /> Análisis por IA (Gemini) incluido</li>
            </ul>
            ...
            <p className="mt-6 text-sm text-neutral-400 font-bold">Sin compromiso, cancela cuando quieras.</p>
          </div>
        </div>
      </section>
...
function FeatureCard({ title, description, icon }: { title: string, description: string, icon: React.ReactNode }) {
  return (
    <div className="p-10 rounded-[2.5rem] bg-neutral-900 border border-white/5 hover:border-primary/50 transition-all group shadow-sm hover:shadow-xl hover:-translate-y-2">
      ...
      <p className="text-neutral-400 leading-relaxed font-bold">{description}</p>
    </div>
  );
}
