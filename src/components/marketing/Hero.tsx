...
export default function Hero() {
    return (
        <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
            ...
            <div className="absolute -top-24 -right-24 w-96 h-96 bg-primary/10 rounded-full blur-3xl -z-10 animate-pulse"></div>
            <div className="absolute top-1/2 -left-24 w-72 h-72 bg-accent/10 rounded-full blur-3xl -z-10 animate-pulse delay-700"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mb-16 lg:mb-20 px-4 sm:px-0">
                    <Link
                        href="/register"
                        className="w-full sm:w-auto px-10 py-5 bg-primary hover:bg-primary-dark text-white rounded-2xl font-black text-xl transition-all shadow-2xl shadow-primary/40 transform hover:-translate-y-1 active:scale-95"
                    >
